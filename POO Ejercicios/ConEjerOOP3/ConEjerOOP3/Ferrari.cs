...
{
    class Ferrari : Equipos
    {
        
        public Ferrari(string nombre, string color, string corredor1, string corredor2, int cantcamppil, int cantcampcons)
        {
        ...
        public int camptot
        {
            get
            {
                return this.p_cantcampconstruc + this.p_cantcamppilot;
            }
        }
