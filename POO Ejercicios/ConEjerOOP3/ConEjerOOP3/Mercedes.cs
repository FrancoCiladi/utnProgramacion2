...
{
    class Mercedes : Equipos
    {
        public Mercedes(string nombre, string color, string corredor1, string corredor2, int cantcamppil, int cantcampcons)
        {
